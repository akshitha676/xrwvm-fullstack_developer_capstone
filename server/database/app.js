...
app.use(express.json()); // optional, to parse JSON
...
Reviews.deleteMany({})
    ...
    .then(() => console.log("Reviews collection initialized"))
...
Dealerships.deleteMany({})
    ...
    .then(() => console.log("Dealerships collection initialized"))
...
app.get('/fetchDealer/:id', async (req, res) => {
    try {
        const dealerId = parseInt(req.params.id); // ensure number
